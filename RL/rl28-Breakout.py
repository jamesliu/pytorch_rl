...
https://ai.atamai.biz/post/08-rl-practice-breakout/

Important to note:
In previous implementations (like for example Pong) we fed our Neural Network with single image from video output.
Here we use 4 stacked together images, which then serve as input for our NN.
...
More details:
http://ai.atamai.biz/post/stackedimages/
